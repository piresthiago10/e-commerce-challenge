...
router.register(r'customers', CustomersViewSet, basename="clientes")
...
router.register(r'new_user', UserCreateViewSet,
                basename="novo_usuario")

urlpatterns = [
    path('api/comission/seller/<int:id>/start_date/<str:start_date>/end_date/<str:end_date>/',
         csrf_exempt(sellers_view.SellersComission.as_view()), name='comissao_vendedor'),
